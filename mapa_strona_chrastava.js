//Tworzenie mapy i map bazowych
				...
				info.update = function (props) {
					this._div.innerHTML = (props ?
						'Yearly mean solar irradiation: '+ '<b>' + props.ITH + '</b>' + '<b>' + ' kWh/m<sup>2</sup>/year' + '</b><br />' +
						'Solar panels suitable area: ' + '<b>' + props.Area + ' m<sup>2</sup>' + '</b><br />' +
						'Possible energy yield for 19% efficiency panels: ' + '<b>' + props.En19 + ' kWh/m<sup>2</sup>/year' + '</b><br />' +
						'Possible energy yield for 16% efficiency panels: ' + '<b>' + props.En16 + ' kWh/m<sup>2</sup>/year' + '</b><br />' +
						'Possible carbon dioxide reduction for 19% efficiency panels: ' + '<b>' + props.Red19 + ' kg/m<sup>2</sup>/year' + '</b><br />' +
						'Possible carbon dioxide reduction for 16% efficiency panels: ' + '<b>' + props.Red16 + ' kg/m<sup>2</sup>/year' + '</b><br />' +
						'Mean roof slope: ' + '<b>' + props.Slope + '°'
						: 'Hover a building');
				};
				...
				function style(feature) {
					return {
						weight: 1.5,
						opacity: 1,
						color: getColor(feature.properties.ITH),
						fillOpacity: 0.50,
						fillColor: getColor(feature.properties.ITH)
					}
				}
				...
				budynki = L.geoJson(bud_chr2_wgs, {
					fillOpacity:0.5,
				...
				//Dodanie rastrów
                var ith = L.imageOverlay('img/ith_chrast_wgs.png', [[50.773977, 14.908970], [50.875420, 15.041762]], {opacity: 1});
                var dur = L.imageOverlay('img/d_chrast.png', [[50.773977, 14.908970], [50.875420, 15.041762]], {opacity: 1});
